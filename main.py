...
def predict(request: Request, sepal_length: float = Form(...), sepal_width: float = Form(...),
    ...
    image_path = f"../static/img/{predicted_class_label}.jpg"

    return templates.TemplateResponse("result.html", {"request": request, "predicted_class_label": predicted_class_label, "image_path": image_path})
